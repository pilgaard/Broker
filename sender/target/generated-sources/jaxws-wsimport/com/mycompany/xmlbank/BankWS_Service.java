 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://xmlbank.mycompany.com/", wsdlLocation = "http://localhost:8080/BankWS/BankWS?WSDL")
    ...
    extends Service
{
    ...
    private final static QName BANKWS_QNAME = new QName("http://xmlbank.mycompany.com/", "BankWS");
    ...
    public BankWS getBankWSPort() {
        return super.getPort(new QName("http://xmlbank.mycompany.com/", "BankWSPort"), BankWS.class);
    }
    ...
    public BankWS getBankWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://xmlbank.mycompany.com/", "BankWSPort"), BankWS.class, features);
    }
